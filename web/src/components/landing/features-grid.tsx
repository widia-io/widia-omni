...
const features = [
  ...
  { icon: Activity, title: "Hábitos", desc: "Rastreie hábitos diários com heatmaps e sequências de dias.", color: "text-accent-blue" },
  { icon: Calendar, title: "Tarefas", desc: "Organize tarefas por prioridade e foco, conectadas a suas metas.", color: "text-accent-orange" },
  { icon: DollarSign, title: "Finanças", desc: "Categorize transações, defina orçamentos e acompanhe o saldo mensal.", color: "text-accent-sand" },
  { icon: PenLine, title: "Journal", desc: "Registre humor, energia, vitórias e gratidão diariamente.", color: "text-accent-rose" },
  { icon: BarChart3, title: "Life Score", desc: "Pontuação semanal que reflete o equilíbrio entre todas as áreas da vida.", color: "text-accent-sage" },
];
  ...
  return (
    <section id="features" className="mx-auto max-w-6xl px-6 py-24">
      ...
      <p className="mx-auto mb-12 max-w-lg text-center font-serif text-text-secondary">
        Uma plataforma integrada para gerenciar todas as dimensões da sua vida.
      </p>
