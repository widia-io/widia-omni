    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-bg-primary/80 backdrop-blur-sm">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        <Link to="/" className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-accent-orange to-accent-rose text-xs font-bold text-text-primary">
            MC
          </div>
          <span className="text-lg font-bold text-text-primary">Mission Control</span>
        </Link>
